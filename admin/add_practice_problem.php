    ...
    <div class="col-sm-8 text-left" style = "height : 550px; width: 500px; margin-left: 15%; margin-top: 30px;"> 
        ...
        if (isset($_POST['problem'])) {
            ...
            if (move_uploaded_file($filename, $destination)) {
                ...
                $sql = "insert into practice_problem(problem_id, problem_name, problem_path, input_set, output_set) values('$_POST[problem_id]', '$_POST[problem_name]','$directory', '$_POST[input_set]', '$_POST[output_set]')";
        ...
        <form action="" method="post" enctype ="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="problem_id" name="problem_id" placeholder="Problem Id">
            </div>
