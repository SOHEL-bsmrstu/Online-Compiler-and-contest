...
<input type="submit" id="st" class="btn btn-success" value="Run Code"><br><br><br>
    ...
    <div style=" background: gray; color: white; height: 200px; border: 1px solid blue; margin-top: -190px; width: 265px; margin-left: 115%; ">
        <h2>NB:</h2>
        <p style=" text-align: justify; margin: 2px; font-size: 20px;">For java language need not to write package name and public function name must be "Main"</p>
    </div>
